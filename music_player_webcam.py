...
while True:
    ...
    if time.time() > future:##after 20second music will play
        try:
            ...
            if text == 'Angry':
                randomfile = random.choice(os.listdir("C:/Users/Ammar Bharmal/Desktop/Music_player_with_Emotions_recognition-master/Music_player_with_Emotions_recognition-master/Songs/Angry/"))
                print('You are angry !!!! please calm down:) ,I will play song for you :' + randomfile)
                file = ('C:/Users/Ammar Bharmal/Desktop/Music_player_with_Emotions_recognition-master/Music_player_with_Emotions_recognition-master/Songs/Angry/' + randomfile)
                subprocess.call([mp, file])

            if text == 'Smile':
                randomfile = random.choice(os.listdir("C:/Users/Ammar Bharmal/Desktop/Music_player_with_Emotions_recognition-master/Music_player_with_Emotions_recognition-master/Songs/Happy/"))
                print('You are smiling :) ,I playing special song for you: ' + randomfile)
                file = ('C:/Users/Ammar Bharmal/Desktop/Music_player_with_Emotions_recognition-master/Music_player_with_Emotions_recognition-master/Songs/Happy/' + randomfile)
                subprocess.call([mp, file])

            if text == 'Fear':
                randomfile = random.choice(os.listdir("C:/Users/Ammar Bharmal/Desktop/Music_player_with_Emotions_recognition-master/Music_player_with_Emotions_recognition-master/Songs/Sad/"))
                print('You have fear of something ,I playing song for you: ' + randomfile)
                file = ('C:/Users/Ammar Bharmal/Desktop/Music_player_with_Emotions_recognition-master/Music_player_with_Emotions_recognition-master/Songs/Sad/' + randomfile)
                subprocess.call([mp, file])
